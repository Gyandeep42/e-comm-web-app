...
?>
     ...
     <div class="successmsg"><span style="font-size:100px , background-color:#000;">&#9989;</span> <br> You have registered successfully . <br> <a href="login.php" style="color:#fff;">Login here... </a> </div>
      <?php } else { ?>
